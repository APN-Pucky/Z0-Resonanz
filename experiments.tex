...
\begin{iframe}
	\begin{itemize}
		...
		\pause
		\item  $u + \overline{u} \rightarrow Z^0 $: $pp$-Kollision benötigt $\sqrt{s} \gtrapprox \SI{600}{GeV}$ pro Proton
		\pause
		\item $u  + \overline{u} \rightarrow Z^0 $: $p\overline{p}$-Kollision benötigt $\sqrt{s}\gtrapprox \SI{300}{GeV}$
		\pause
...
\begin{iframe}
	...
	\only<1> {
		...
		\note[item]{Breite + Mittelwert} %TODO
	}
	\only<2> {

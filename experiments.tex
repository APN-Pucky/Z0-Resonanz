...
\begin{iframe}
	...
	\note[item]{Veranschaulichung der Seequarks, Pfeile nicht direkt relevant}
	\note[item]{Keine Trennung up-down, sondern grün ist Antiquark}
\end{iframe}
...
\end{columns}
	...
	\note[item] {$\nu$ Spinpräzessionen pro Speicherringdurchlauf}
	\note[item] {Polarisation durch Solokov-Ternov Mechanismus, relativistische Elektronen/Positronen polarisieren durch spin-flip synchrotron radiation (92.4\%)}
	\note[item] {Andere Effekte sorgen auch für Spinpräzession}

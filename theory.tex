...
%\note[item]{Masse der Bosonen, da Reichweite eingeschränkt ist}
...
\note[item]{Gluon Kernzusammenhalt,Farbladung,8 Sorten (n-p-Anziehung), Quarkanziehung}

\note[item]{Nur durch Z-Boson lässt sich Neutrino-Neutrino-WW erklären, da sie nicht elektrisch sind.}

\note[item]{Warum? Weil Divergenzen in höherer Ordnung/Energien auftreten ($E>M_W$)}
%\note[item]{Schwache/Fermi WW divergiert bei Energien größer als W Boson Masse und ist nicht renormierbar}
...
\note[item]{Vereint QED mit schwacher WW.}
\note[item]{Schwache/Fermi WW divergiert bei Energien nicht kleiner als W Boson Masse und ist nicht renormierbar}
\note[item]{Masse der Bosonen, da Reichweite eingeschränkt ist}
\note[item]{ Kräfte durch Austauschteilchen}
\note[item] { Photon elektro magn. beispielweise Elektron-Elektron-Streuung, Rutherford Streuung}
\note[item]{W,Z bsplw. Beta-Zerfall, Elektron-Positron-Streuung (Energieabhänig)}
...
\note[item]{ Einführung von schwachem Isospin, analogon zu starkem Isospin}
	...
	\note[item]{ Rechtshändige $e,\mu,\tau$ Singulett Zustand.}
		\note[item]{ Chiralität (l/r),Helizität, aber lorentzinvariant, Spinor Symmetrie}
...
\caption*{$K^+$-Zerfall\cite{beta}}\end{figure}
	...
	\note[item]{ einzelne Zerfälle erläutern}
